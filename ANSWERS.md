...
Hints — это директивы SQL Server, позволяющие разработчику влиять на выбор плана выполнения запроса, использование индексов, блокировок и других механизмов оптимизации. Использовать их нужно осторожно, потому что неверный hint может ухудшить производительность.
...
Основные блокировки SQL Server — Shared, Exclusive и Update. Shared используется при чтении, Exclusive — при изменении данных, Update — при подготовке к изменению. Также есть intent-блокировки, блокировки схемы и диапазонов ключей. Блокироваться могут строки, страницы или целые таблицы.
...
Федеральный закон № 223-ФЗ «О закупках товаров, работ, услуг отдельными видами юридических лиц» регулирует общие принципы и порядок закупок компаний с государственным участием, естественных монополий и организаций, осуществляющих регулируемые виды деятельности [223-ФЗ, Ст. 1].

Согласно статье 1 указанного закона, регулированию подлежат закупки следующих категорий заказчиков:

- Государственные корпорации и государственные компании (например, Росатом, Ростех) [223-ФЗ, Ст. 1].
- Субъекты естественных монополий (например, РЖД) [223-ФЗ, Ст. 1].
- Организации, осуществляющие регулируемые виды деятельности в сфере электроснабжения, газоснабжения, водоснабжения [223-ФЗ, Ст. 1].
- Хозяйственные общества с долей участия государства или муниципальных образований в уставном капитале более 50 процентов [223-ФЗ, Ст. 1].
- Дочерние хозяйственные общества, в уставном капитале которых доля указанных выше юридических лиц в совокупности превышает 50 процентов [223-ФЗ, Ст. 1].
- Бюджетные учреждения при осуществлении закупок за счет грантов, средств от приносящей доход деятельности и средств субподряда [223-ФЗ, Ст. 1].

Закон устанавливает общие требования к закупкам, обязывая заказчиков разработать и разместить в Единой информационной системе (ЕИС) собственное Положение о закупке, которое является главным документом, регламентирующим их закупочную деятельность [223-ФЗ, Ст. 2].
...
B to B (Business-to-Business, «бизнес для бизнеса») — это модель коммерческого взаимодействия, при которой одна компания продает товары, работы или услуги другим компаниям для обеспечения их деятельности.
